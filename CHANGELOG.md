...
## 🚀 v1.3.0 全球发布 (Global Release)

- 🌍 **全球化支持**: 新增 8 种语言支持（中、英、西、韩等），界面与 AI 自动适配。
- 🌓 **双栏预览**: 左侧编辑 Markdown，右侧实时预览渲染效果。
- 🖼️ **图片拖拽**: 支持直接拖拽或粘贴图片到笔记中。
- ⚡ **效率提升**: 新增编辑器模式切换与专注模式快捷键。
- 🎨 **UI 细节优化**: 更加精致的编辑器控制栏与动态图标。

---

## 🚀 v1.2.4 发布亮点

- 🔒 **macOS 权限修复**: 引入 Security-Scoped Bookmarks 机制，彻底解决 MAS 版本下的文件访问权限丢失问题。
- ⚡ **Windows 性能优化**: 移除不稳定的 WebLLM 内置引擎，推荐使用 Ollama 以获得更流畅、稳定的体验。
- 🐛 **已知问题修复**: 修复了多个导致未定义行为的小问题。
