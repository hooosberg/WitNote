...
function returnResults(it) {
  ...
  if (schemaEnv.$async) {
    gen.if((0, codegen_1$R._)`${names_1$9.default.errors} === 0`, () => gen.return(names_1$9.default.data), () => gen.throw((0, codegen_1$R._)`new ${ValidationError3}(${names_1$9.default.vErrors})`));
  } else {
